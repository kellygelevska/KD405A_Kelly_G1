...
public class DigitalGUI extends JFrame {
	...
	public DigitalGUI() {
		...
		timeLabel.setFont(new Font("Josefin Sans", Font.BOLD, 30));
		...
		lblAlarmClock.setFont(new Font("Josefin Sans", Font.BOLD, 24));
		lblAlarmClock.setBounds(160, 6, 127, 31);
	...
	public void setTimeOnLabel1(String time) {
